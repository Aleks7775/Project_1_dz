...
def test_get_date(data_entry, data_out):
    """Тестирование правильности преобразования даты"""
    assert get_date(data_entry) == data_out


def test_get_date_format(data_get_format):
